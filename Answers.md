...
For remidiation, it is recommended to upgrade to Pillow-Version 10.2.0 or higher because the vulnerability is related Pillow versions less than 10.1.0. The vulnerability causes improper control, which means an attacker can gain unuintended-unauthorized access to the Pillow image and craft a malicious image file that can execute unintended code.
